"""Minimal Vercel adapter — exports only app and wsgi_handler.

This file is intentionally minimal to avoid runtimes instantiating a
BaseHTTPRequestHandler (which can return 501 for unimplemented methods).
"""
import sys
import os
import traceback
